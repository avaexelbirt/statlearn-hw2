...
ggplot(df_for_class, aes(x = budget)) +
  geom_histogram(binwidth = 1e7, fill = "blue", color = "black", alpha = 0.7) +  # Increase binwidth
  labs(title = "Distribution of Budget", x = "Budget", y = "Count") +
  theme_minimal()
...
ggplot(df_for_class, aes(x = budget, y = success)) +
  geom_point() + 
  labs(title = "Budget vs Success", x = "Budget", y = "Success") +
  theme_minimal()

ggplot(df_for_class, aes(x = release_year, y = success)) +
  geom_point() + 
  labs(title = "Release Year vs Success", x = "Release Year", y = "Success") +
  theme_minimal()

ggplot(df_for_class, aes(x = popularity, y = success)) +
  geom_point() + 
  labs(title = "Popularity vs Success", x = "Popularity", y = "Success") +
  theme_minimal()

ggplot(df_for_class, aes(x = run_time, y = success)) +
  geom_point() + 
  labs(title = "Runtime vs Success", x = "Runtime", y = "Success") +
  theme_minimal()
