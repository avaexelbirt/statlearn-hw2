...
```
# Simulating the data MUST GET RID BEFORE TURNING IN!
```{r}
...
# Removing budget and revenue outliers
...
horror <- horror
horror <- remove_outliers(horror, "budget")
horror <- remove_outliers(horror, "revenue")
...
# Predicting Budget using regression
